...
<html lang="en-US" class="no-js">
	<head>
		...
		<link rel="stylesheet" href="css/animations.f0731558.css" type="text/css">
		...
		<div class='container'>
			...
			<div class='animatedParent col-md-6' data-sequence='1000' >
				<p class='animated bounceInLeft' data-id='1'>
					Include <a href='js/css3-animated.js'>css3-animated.js</a> at the end of your file and <a href='css/animations.f0731558.css'>animations.css</a> in the head.
				</p>
...
<script src='js/css3-animate-it.6b82c56c.js'></script>
